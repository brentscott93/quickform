...
golem::fill_desc(
  pkg_name = "quickform", # The Name of the package containing the App
  pkg_title = "Create a google form look-a-like shiny app", # The Title of the package containing the App
...
usethis::use_mit_license( name = "Brent " )  # You can set another license here
